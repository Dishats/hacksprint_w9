...
<div class="modal-footer display">
	<div class="row">
		<div class="col-lg-12">
			...
			<?php endif; ?>
			<!-- /* sendmail button code  start*/ -->
			<form method="post" action="mail.php">
					<button class="btn float-right btn-primary sendMail mr-2" name="button_pressed"  id="sendMail" type="button">sendMail</button>
				</form>
				<!-- /* sendmail button code  end*/ -->
		</div>
	</div>
</div>
<script>
