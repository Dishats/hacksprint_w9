				...
				<form action="" id="manage-event">
					...
					<div class="form-group row">
						<div class="col-md-10">
							...
							<textarea name="content" id="content" class="form-control jqte" cols="30" rows="5"  required><?php echo isset($content) ? html_entity_decode($content) : '' ?>
							<a href="https://forms.gle/Mb3o7JrTxQVtNUPK8">register here..!! </a>	
							</textarea>
						</div>
					</div>
